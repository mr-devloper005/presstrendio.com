...
export const editableRootStyle = {
  '--slot4-page-bg': '#f5f6f8',
  '--slot4-page-text': '#20242c',
  '--slot4-panel-bg': '#edf0f5',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#6f7480',
  '--slot4-soft-muted-text': '#8c929d',
  '--slot4-accent': '#f5bd2d',
  '--slot4-accent-fill': '#f5bd2d',
  '--slot4-accent-soft': '#fff3cf',
  '--slot4-dark-bg': '#111a2c',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#dfe5ef',
  '--slot4-cream': '#f5f6f8',
  '--slot4-warm': '#ffffff',
  '--slot4-lavender': '#f5bd2d',
  '--slot4-gray': '#e8ecf2',
  '--slot4-navy': '#111a2c',
  '--slot4-navy-soft': '#263655',
  '--slot4-teal': '#08c9aa',
  '--slot4-body-gradient': 'linear-gradient(180deg, #ffffff 0%, #f5f6f8 58%, #edf0f5 100%)',
} as CSSProperties
...
export const aiLayoutRules = [
  ...
  'Use a media-distribution style white masthead, deep navy panels, mustard accents, and sharp image-led grids.',
